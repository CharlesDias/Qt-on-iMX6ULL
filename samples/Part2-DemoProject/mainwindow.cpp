    ...
    , ui(new Ui::MainWindow)
{
    ...
    if(!m_outputLine)
    {
        qFatal("The getGpioLine function returned NULL!");
    }

    /* Configure the GPIO line as output. */
    int ret = gpiod_line_request_output(m_outputLine, "gpioRelay", GPIOD_LINE_ACTIVE_STATE_HIGH);
    if(ret)
    {
        qFatal("The gpiod_line_request_output function failed!");
    }
